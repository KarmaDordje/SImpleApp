...
class MainToolbarView(wx.ToolBar):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.Bind(wx.EVT_TOOL, self.toolbar_controller.FindFile, id=con.ID_FIND_ORDER)