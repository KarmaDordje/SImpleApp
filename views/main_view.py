...
from views.create_new_order_view import CreateNewOrderView
import wx
...
class MainWindow(wx.Frame):
    def __init__(self, *args, **kwargs):
        ...
        self.Bind(wx.EVT_TOOL, self.CreateNewFIle, id=con.ID_CREATE_NEW_FILE)
        self.Bind(wx.EVT_TOOL, self.AddNewUser, id=con.ID_ADD_NEW_USER)
    ...
    def AddNewUser(self, e):
        add_new_user = AddNewOperator(parent=None, id=con.ID_ADD_NEW_USER)
        add_new_user.Show()
...
#         wx.Frame.__init__(self, id, parent, size=(1000, 440))
